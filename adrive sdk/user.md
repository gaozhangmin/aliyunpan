...
POST: `https://api.alipan.com/apps/v1/users/apps/widgets`
...
POST: `https://api.alipan.com/v2/user/get`
...
POST: `https://api.alipan.com/v2/user/update`
...
POST: `https://api.alipan.com/adrive/v1/user/driveCapacityDetails`
...
POST: `https://api.alipan.com/adrive/v1/user/albums_info`
...
POST: `https://api.alipan.com/adrive/v1/user_verify/get`
...
POST: `https://api.alipan.com/v2/databox/get_personal_info`
...
POST: `https://api.alipan.com/apps/v1/users/list_app_permissions`
...
POST: `https://api.alipan.com/users/v1/users/device_list`
...
> POST: `https://api.alipan.com/users/v1/users/device_offline`
...
POST: `https://api.alipan.com/adrive/v1/user/albums_migration`
...
POST: `https://api.alipan.com/users/v1/users/device`
...
POST: `https://api.alipan.com/adrive/v1/user/capacityDetails`
