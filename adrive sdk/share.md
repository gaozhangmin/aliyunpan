...
POST: `https://api.alipan.com/adrive/v3/share_link/list`
...
POST: `https://api.alipan.com/adrive/v2/share_link/get`
...
POST: `https://api.alipan.com/adrive/v2/share_link/get_share_msg`
...
POST: `https://api.alipan.com/adrive/v2/share_link/update`
...
POST: `https://api.alipan.com/adrive/v2/share_link/cancel`
...
POST: `https://api.alipan.com/adrive/v2/share_link/create`
...
POST: `https://api.alipan.com/adrive/v2/share_link/check_available`
...
POST: `https://api.alipan.com/adrive/v2/share_link/extract_code`
...
POST: `https://api.alipan.com/adrive/v2/share_link/get_share_by_anonymous`
...
POST: `https://api.alipan.com/v2/file/get_share_link_download_url`
...
```json
{
  "download_url": "https://pdsapi.alipan.com/v2/redirect?id=a8c5bda295434d4987610b391010bbd5",
  "url": "https://pdsapi.alipan.com/v2/redirect?id=8b59b11717984cab801f651f6503f064",
  "thumbnail": "https://pdsapi.alipan.com/v2/redirect?id=e511a261a19949399d9a2ab7cb0bc31a"
}
```

#### 分享链接内文件的预览地址

POST: `https://api.alipan.com/v2/file/get_share_link_video_preview_play_info`
    ...
    "live_transcoding_task_list": [
      {
        ...
        "status": "finished",
        "stage": "stage_none",
        "url": "https://pdsapi.alipan.com/v2/redirect?id=15b59a72f8904636bbca16bfa64fbd6d",
        "preview_url": "https://pdsapi.alipan.com/v2/redirect?id=467363f46e1e490fa5811ba52c320744",
...
POST: `https://api.alipan.com/adrive/v1/share_link/subscription/update`
...
POST: `https://api.alipan.com/adrive/v1/file/copy`
...
POST: `https://api.alipan.com/v2/async_task/get`
