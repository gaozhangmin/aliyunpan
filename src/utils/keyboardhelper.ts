...
const menulist = ['leftpansubmove', 'leftrespansubmove','leftpansubzhankai', 'leftrespansubzhankai', 'leftpanmenu','leftrespanmenu', 'rightpansubmove', 'rightrespansubmove', 'rightpansubbiaoji',
  'rightrespansubbiaoji', 'rightpansubmore', 'rightpanmenu', 'rightpantrashmenu',  'rightrespansubmore', 'rightrespanmenu', 'rightrespantrashmenu', 'rightmysharemenu', 'righthistorysharemenu', 'rightmytransfersharemenu', 'rightothersharemenu',
