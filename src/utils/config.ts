export default class Config {
  ...
  static qrCodeLoginUrl = 'https://openapi.alipan.com/oauth/authorize/qrcode'
  static accessTokenUrl = 'https://openapi.alipan.com/oauth/access_token'
  static driverInfoUrl = 'https://openapi.alipan.com/adrive/v1.0/user/getDriveInfo'
  static listFile = 'adrive/v1.0/openFile/list'
  static recentPlayListUrl = 'https://openapi.alipan.com/adrive/v1.0/openFile/video/recentList'
