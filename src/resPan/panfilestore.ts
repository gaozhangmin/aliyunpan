...
const useResPanFileStore = defineStore('respanfile', {
  state: (): State => ({
    DriveID: '',
    DirID: '',
    DirName: '',
  ...
  actions: {
    ...
    mSetMovieMode(movieFlag:boolean) {
      this.$patch({openMoviePage: movieFlag})
    },
...
export default useResPanFileStore
