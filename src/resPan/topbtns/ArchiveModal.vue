...
export default defineComponent({
  ...
  methods: {
    ...
    handleOK(savetype: string) {
      ...
      modalSelectPanDir('resourcePan','unzip', this.parent_file_id, async (user_id: string, drive_id: string, dirID: string) => {
        ...
        if (result) {
          if (result.state == 'Succeed') {
            ...
            await PanDAL.aReLoadOneDirToShow(drive_id, 'refresh', false)
