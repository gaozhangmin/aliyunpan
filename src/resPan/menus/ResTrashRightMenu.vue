...
import { topRestoreSelectedFile, topRecoverSelectedFile, menuTrashSelectFile } from '../topbtns/ResTopbtn'
...
<template>
  <a-dropdown id="rightrespantrashmenu" class="rightmenu" :popup-visible="true" style="z-index: -1; left: -200px; opacity: 0">
    <template #content>
