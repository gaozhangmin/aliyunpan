...
import { ref } from 'vue'
import HistoryShareRight from './share/HistoryShareRight.vue'
...
appStore.$subscribe((mutation) => {
  ...
  if (appPage == 'HistoryShareRight') ShareDAL.aReloadHistoryShare(useUserStore().user_id, false)
...
<!--        </a-menu-item>-->
        ...
        <a-menu-item key='HistoryShareRight'>
...
<!--        </a-tab-pane>-->
        ...
        <a-tab-pane key='HistoryShareRight' title='3'>
          <HistoryShareRight />
        </a-tab-pane>
        <a-tab-pane key='MyShareRight' title='4'>
          <MyShareRight />
        </a-tab-pane>
        <a-tab-pane key='MyTransferShareRight' title='5'>
          <MyTransferShareRight />
        </a-tab-pane>
        <a-tab-pane key='ShareBottleFishRight' title='5'>
          <ShareBottleFishRight />
        </a-tab-pane>
        <a-tab-pane key='MyFollowingRight' title='6'>
          <MyFollowingRight />
        </a-tab-pane>
        <a-tab-pane key='OtherFollowingRight' title='7'>
          <OtherFollowingRight />
        </a-tab-pane>
        <a-tab-pane key="alist" title="8">
          <AList />
        </a-tab-pane>
      </a-tabs>
    </a-layout-content>
