...
<template>
  <div class='settingcard'>
    ...
    <MySwitch class='switcher' :value='settingStore.securityEncFileName'
    ...
    <MySwitch class='switcher' :value='settingStore.securityEncFileNameHideExt'
    ...
    <MySwitch class='switcher' :value='settingStore.securityPasswordConfirm'
    ...
    <MySwitch class='switcher' :value='settingStore.securityFileNameAutoDecrypt'
    ...
    <MySwitch class='switcher' :value='settingStore.securityPreviewAutoDecrypt'
