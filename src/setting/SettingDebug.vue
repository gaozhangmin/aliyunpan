...
import { getUserData, openLocalPath } from '../utils/electronhelper'
...
<!--    </div>-->
    ...
    <div class="settingrow">
      <a-input tabindex='-1' :model-value='userData' placeholder='C:\Users\用户名\AppData\Roaming\alixby'
               :readonly='true' />
    </div>
    <div class="settingspace"></div>
    <div class="settinghead"></div>
