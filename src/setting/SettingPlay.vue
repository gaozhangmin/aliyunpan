...
<template>
  <div class='settingcard'>
      ...
      <a-popover position='bottom'>
        ...
        <template #content>
          <div style='min-width: 400px'>
            ...
            【内置网页播放器】播放加密视频! 画中画模式! 支持倍速！支持选择清晰度！支持播放历史！支持播放列表！支持字幕选择！
    ...
    <template v-if="settingStore.uiVideoPlayer === 'other'">
      ...
      <div class='settingrow'>
        <MySwitch class='switcher'   :value='settingStore.uiVideoQualityTips'
      ...
      <div class='settingrow'>
        <MySwitch class='switcher'   :value='settingStore.uiVideoQualityLastSelect'
      ...
      <template v-if='playerType.includes("mpv") || playerType.includes("potplayer")'>
        ...
        <div class='settingrow'>
          <MySwitch class='switcher' :value='settingStore.uiVideoEnablePlayerList'
      ...
      <template v-if='settingStore.uiVideoEnablePlayerList && !playerType.includes("mpv")'>
        ...
        <div class='settingrow'>
          <MySwitch class='switcher' :value='settingStore.uiVideoPlayerExit' @update:value='cb({ uiVideoPlayerExit: $event })'>
            跟随软件一同退出
          </MySwitch>
        </div>
      </template>
      ...
      <div class='settingrow'>
        <MySwitch class='switcher' :value='settingStore.uiVideoPlayerHistory' @update:value='cb({ uiVideoPlayerHistory: $event })'>
          跳转并记忆播放历史
        </MySwitch>
        <a-popover position='bottom'>
          <i class='iconfont iconbulb' />
  ...
  <div class='settingcard'>
    ...
    <div class='settingrow'>
      <MySwitch class='switcher'   :value='settingStore.uiAutoColorVideo' @update:value='cb({ uiAutoColorVideo: $event })'>
        观看视频时 将视频自动标记为浅红色
      </MySwitch>
    </div>
    <div class='settingspace'></div>
    ...
    <div class='settingrow'>
      <MySwitch class='switcher'   :value='settingStore.uiAutoPlaycursorVideo' @update:value='cb({ uiAutoPlaycursorVideo: $event })'>
        观看视频时 将播放进度同步到网盘放映室
      </MySwitch>
      <a-popover position='bottom'>
        <i class='iconfont iconbulb' />
