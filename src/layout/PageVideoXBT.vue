...
export default defineComponent({
  setup() {
    ...
    const handleCopyM3U8Click = () => {
      const pageVideoXBT = appStore.pageVideoXBT!
      AliFile.ApiVideoPreviewUrlOpenApi(pageVideoXBT.user_id, pageVideoXBT.drive_id, pageVideoXBT.file_id).then((data) => {
        if (data && data.url) {
    ...
    const handleCopyDownClick = () => {
      const pageVideoXBT = appStore.pageVideoXBT!
      AliFile.ApiFileDownloadUrlOpenApi(pageVideoXBT.user_id, pageVideoXBT.drive_id, pageVideoXBT.file_id, 14400).then((data) => {
