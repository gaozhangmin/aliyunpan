...
import DLNAPlayerResModal from '../resPan/topbtns/DLNAPlayerResModal.vue'
...
import PageMovie from './PageMovie.vue'
import SearchMovieMeta from './SearchMovieMeta.vue'
...
<template>
  ...
  <SearchMovieMeta :visible="modalStore.modalName == 'moviemeta'" :movies="modalStore.modalData.movies || []" />
  ...
  <DaoRuShareLinkModal :visible="modalStore.modalName == 'backupImporthare'" :shareUrl="modalStore.modalData.shareUrl || ''" :sharePwd="modalStore.modalData.sharePwd || ''" />
  ...
  <DLNAPlayerResModal :visible="modalStore.modalName == 'resdlna'" />
  ...
  <ShowShareLinkModal
    ...
    :dirId="modalStore.modalData.dirId || ''"
    :panType="modalStore.modalData.panType"/>
